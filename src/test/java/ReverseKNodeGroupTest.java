...
public class ReverseKNodeGroupTest {
	...
	public void reverseKGroupLinkedList() {
		...
		Node actual = ReverseKNodeGroup.reverse(head, 2);
		Assert.assertEquals(actual.data, 2);
		Assert.assertEquals(actual.next.data, 1);
		...
		Assert.assertEquals(actual.data, 2);
		Assert.assertEquals(actual.next.data, 1);
		Assert.assertEquals(actual.next.next.data, 3);
		Assert.assertNull(actual.next.next.next);

		head = new Node(1, new Node(2, new Node(3, null)));
		actual = ReverseKNodeGroup.reverse(head, 3);
		Assert.assertEquals(actual.data, 3);
		Assert.assertEquals(actual.next.data, 2);
		...
		Assert.assertEquals(actual.data, 2);
		Assert.assertEquals(actual.next.data, 1);
		Assert.assertEquals(actual.next.next.data, 4);
		Assert.assertEquals(actual.next.next.next.data, 3);

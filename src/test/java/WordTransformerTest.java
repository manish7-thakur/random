...
public class WordTransformerTest {
  ...
  public void findShortestTransformations() {
   ...
   expected = Arrays.asList(
           Arrays.asList("qa", "pa", "pb", "sb", "sq"), Arrays.asList("qa", "pa", "pt", "st", "sq"), Arrays.asList("qa", "pa", "ph", "sh", "sq"),
           Arrays.asList("qa", "pa", "pi", "si", "sq"), Arrays.asList("qa", "pa", "pm", "sm", "sq"), Arrays.asList("qa", "pa", "po", "so", "sq"),
           Arrays.asList("qa", "na", "no", "so", "sq"), Arrays.asList("qa", "na", "nb", "sb", "sq"), Arrays.asList("qa", "na", "ne", "se", "sq"),
           Arrays.asList("qa", "na", "ni", "si", "sq"), Arrays.asList("qa", "ma", "mn", "sn", "sq"), Arrays.asList("qa", "ma", "mo", "so", "sq"),
           Arrays.asList("qa", "ma", "mb", "sb", "sq"), Arrays.asList("qa", "ma", "mr", "sr", "sq"), Arrays.asList("qa", "ma", "mt", "st", "sq"),
           Arrays.asList("qa", "ma", "me", "se", "sq"), Arrays.asList("qa", "ma", "mi", "si", "sq"), Arrays.asList("qa", "la", "ln", "sn", "sq"),
           Arrays.asList("qa", "la", "lo", "so", "sq"), Arrays.asList("qa", "la", "lr", "sr", "sq"), Arrays.asList("qa", "la", "lt", "st", "sq"),
           Arrays.asList("qa", "la", "le", "se", "sq"), Arrays.asList("qa", "la", "li", "si", "sq"), Arrays.asList("qa", "ya", "yo", "so", "sq"),
           Arrays.asList("qa", "ya", "yb", "sb", "sq"), Arrays.asList("qa", "ya", "ye", "se", "sq"), Arrays.asList("qa", "ha", "hi", "si", "sq"),
           Arrays.asList("qa", "ha", "ho", "so", "sq"), Arrays.asList("qa", "ha", "he", "se", "sq"), Arrays.asList("qa", "ga", "go", "so", "sq"),
           Arrays.asList("qa", "ga", "ge", "se", "sq"), Arrays.asList("qa", "fa", "fm", "sm", "sq"), Arrays.asList("qa", "fa", "fr", "sr", "sq"),
           Arrays.asList("qa", "fa", "fe", "se", "sq"), Arrays.asList("qa", "ta", "th", "sh", "sq"), Arrays.asList("qa", "ta", "ti", "si", "sq"),
           Arrays.asList("qa", "ta", "tm", "sm", "sq"), Arrays.asList("qa", "ta", "to", "so", "sq"), Arrays.asList("qa", "ta", "tb", "sb", "sq"),
           Arrays.asList("qa", "ta", "tc", "sc", "sq"), Arrays.asList("qa", "ca", "ci", "si", "sq"), Arrays.asList("qa", "ca", "cm", "sm", "sq"),
           Arrays.asList("qa", "ca", "co", "so", "sq"), Arrays.asList("qa", "ca", "cr", "sr", "sq"), Arrays.asList("qa", "ra", "rb", "sb", "sq"),
           Arrays.asList("qa", "ra", "re", "se", "sq"), Arrays.asList("qa", "ra", "rh", "sh", "sq"), Arrays.asList("qa", "ra", "rn", "sn", "sq"),

...
public class CandyDistributorTest {
  ...
  public void distributeCandies() {
    ...
    actual = CandyDistributor.candy(new int[] {0, 1, 2, 3, 1});
    expected = 11;
    Assert.assertEquals(expected, actual);
    ...
    actual = CandyDistributor.candy(new int[] {0, 3, 4, 3, 2, 1});
    expected = 13;
    Assert.assertEquals(expected, actual);

    actual = CandyDistributor.candy(new int[] {1, 6, 10, 8, 7, 3, 2});
    expected = 18;
    Assert.assertEquals(expected, actual);

    actual = CandyDistributor.candy(new int[] {0, 1, 2, 4, 6, 7, 5, 4, 3, 2});
    expected = 31;
    Assert.assertEquals(expected, actual);
    ...
    actual = CandyDistributor.candy(new int[] {0, 1, 2, 3, 2, 1, 0});
    expected = 16;
    Assert.assertEquals(expected, actual);
    ...
    actual = CandyDistributor.candy(new int[] {1, 1, 1, 1});
    expected = 4;
    Assert.assertEquals(expected, actual);

    actual = CandyDistributor.candy(new int[] {1, 1, 2, 1, 1});
    expected = 6;
    Assert.assertEquals(expected, actual);

...
public class ArrayArrangerTest {
    ...
    public void findIntersectionOf2Arrays() {
      List<Integer> actual = ArrayArranger.intersect(new int[]{1}, new int[]{1});
      List<Integer> expected = Arrays.asList(1);
      Assert.assertEquals(expected, actual);

      actual = ArrayArranger.intersect(new int[]{1, 2}, new int[]{1, 2});
      expected = Arrays.asList(1, 2);
      Assert.assertEquals(expected, actual);

      actual = ArrayArranger.intersect(new int[]{3, 6, 3}, new int[]{2, 3, 3});
    ...
    public void searchTargetInRotatedSortedArray() {
      ...
      actual = ArrayArranger.searchInRotatedSortedArray(new int[]{5, 6, 7, 8, 1, 2, 3, 4}, 5);
      expected = 0;
      Assert.assertEquals(expected, actual);

      actual = ArrayArranger.searchInRotatedSortedArray(new int[]{4, 5, 6, 7, 8, 1, 2, 3}, 8);
      expected = 4;
      Assert.assertEquals(expected, actual);

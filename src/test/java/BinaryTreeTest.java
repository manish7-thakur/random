...
public class BinaryTreeTest {
    ...
    public void diameterOfTheBinaryTree() {
      int actual = BinaryTree.diameterOfBinaryTree(null);
      int expected = 0;
      Assert.assertEquals(expected, actual);

      actual = BinaryTree.diameterOfBinaryTree(new TreeNode(1));
      expected = 0;
      Assert.assertEquals(expected, actual);

      actual = BinaryTree.diameterOfBinaryTree(new TreeNode(1, new TreeNode(2)));
      expected = 1;
      Assert.assertEquals(expected, actual);

      actual = BinaryTree.diameterOfBinaryTree(new TreeNode(1, new TreeNode(2), new TreeNode(3)));
      expected = 2;
      Assert.assertEquals(expected, actual);
    ...
    public void minimumAbsDiffTwoNodesBST() {
      ...
      actual = BinaryTree.getMinimumDifference(new TreeNode(4, new TreeNode(2, new TreeNode(0), new TreeNode(3)), new TreeNode(6)));
      expected = 1;
      Assert.assertEquals(expected, actual);

      actual = BinaryTree.getMinimumDifference(new TreeNode(236, new TreeNode(104, null, new TreeNode(227)), new TreeNode(701, null, new TreeNode(911))));
      expected = 9;
      Assert.assertEquals(expected, actual);
    }
    @Test
    ...
    public void testIfTreesAreSame() {
      ...
      actual = BinaryTree.isSameTree(new TreeNode(4), null);
      Assert.assertFalse(actual);
    ...
    public void binaryTreeAlternateZigzagTraversal() {
      ...
      actual  = BinaryTree.zigzagLevelOrder(new TreeNode(3, new TreeNode(5), new TreeNode(6)));
      expected = List.of(List.of(3), List.of(6, 5));
      Assert.assertEquals(expected, actual);

      actual  = BinaryTree.zigzagLevelOrder(new TreeNode(3, new TreeNode(5, new TreeNode(4), new TreeNode(7)), new TreeNode(6, null, new TreeNode(9))));
      ...
      actual  = BinaryTree.zigzagLevelOrder(new TreeNode(3, new TreeNode(5, new TreeNode(4, new TreeNode(8), new TreeNode(11)), new TreeNode(7, new TreeNode(20), new TreeNode(13))), new TreeNode(6, new TreeNode(14, new TreeNode(15), new TreeNode(16)), new TreeNode(9, new TreeNode(10), new TreeNode(21)))));
